...
namespace SIBI_Kinect
{
    ...
    public static class WritableBitmapExtender
    {
        public static WriteableBitmap SIBIBitmapResize(this WriteableBitmap bitmap, int Width, int Height)
        {
            WriteableBitmap newBitmap = BitmapFactory.ConvertToPbgra32Format(bitmap);
            return newBitmap.Resize(Width, Height, WriteableBitmapExtensions.Interpolation.Bilinear);
        }
